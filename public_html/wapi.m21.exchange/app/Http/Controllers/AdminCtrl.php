...
$ar['transaction_usdt']= $transactions_usdtd=DB::table('system_transactions') ->where('type', 'credit')->where('coin', 'USDT')->orderBy('id', 'desc')->take(100)->get()  ;
      
    
$ar['transaction_brl']= $transactions_BRL=DB::table('system_transactions') ->where('type', 'credit')->where('coin', 'BRIL')->orderBy('id', 'desc')->take(100)->get()  ;
      
    
$ar['transaction_dbik']= $transactions_dbik=DB::table('system_transactions') ->where('type', 'credit')->where('coin', 'dbik')->orderBy('id', 'desc')->take(100)->get()  ;
         ...
         public function LedgetUsers()
{
   ...
   $this->request->user()->token()->revoke();
    ...
    //$user_id= Auth::user()->id;
 $data=DB::table('users')->orderBy('id', 'desc')->take(500)->get()  ;
