...
include "api27.php";
   ...
   Route::any('updatedays','Robot\RobotInvestmentCtrl@updatedays')   ;

   Route::any('checkDeposits','TronCtrl@checkDeposits_v2')   ;

   Route::any('getUSDTDeposits','TronCtrl@getUSDTDeposits')   ;




   Route::any('checkAddress/{address}','TronCtrl@checkDepositsAddress')   ;

   Route::any('notifications','BackgroundCtrl@notifications')   ;

   Route::any('getExchangeRate','SystemCtrl@getexchangeRateFiat')   ;


         Route::post('auth/system/newRate','SystemCtrl@newRate')->name('system.newRate');  
         
         

    Route::prefix('testbot')->group( function() {
      Route::any('user_ids','TestBotCtrl@user_ids')   ;
   
   
   Route::any('processInvestments','InvestmentCtrl@processInvestments')   ;
  ...
  Route::middleware(['auth:api'])->group(function () {
   ...
   Route::any('credit','TestBotCtrl@credit')   ;
   
   
   Route::any('activate_investment','TestBotCtrl@activate_investment')   ;
 ...
 Route::get('getreferbylevelid','ReferCtrl@getreferbylevelid')  ;
...
Route::get('/docs', function () {
     ...
     return redirect()->away('https://documenter.getpostman.com/view/14158774/UyxhmSQz');
...
Route::get('/docs/changelog', function () {
     ...
     return redirect()->away('https://www.getpostman.com/collections/8fca075bd5ced2bfee11');
    
//    return redirect()->away('https://github.com/inwista/wallet/blob/main/changelog');
 ...
 Route::get('v3/test','PixCtrlV3@test')  ;
 
 Route::get('v3/webhook','PixCtrlV3@webhook')  ;
 
 
 
 Route::get('transactionin5minutes','SystemCtrl@transactionin5minutes')  ;
Route::get('trtest','TronCtrl@trtest')->name('RegistetrteststerAPI')  ;
...
Route::post('RegisterAPI','Auth\AuthController@getRegisterAPI')->name('RegisterAPIgetRegisterAPI')  ;
 ...
 Route::post('v1/getStatus','ApiPixCtrl@getStatus') ->name('sApiPixCtrgetQRCodeDynamicQRCode');
       
     
 Route::post('v1/QRCode','SystemCtrl@pixdepositaddress') ->name('sApiPgetQRCodee');
 
});



 Route::get('v1/sendnotification','TronCtrl@sendnotification')  ;

 Route::middleware(['auth:api'])->group(function () {
    
 Route::get('v1/get_tron_address_details','TronCtrl@get_tron_address_details') ->name('sApiPixCtrgetQRCodeDynamicQRCode');
 
 Route::post('v1/get_tron_address','TronCtrl@get_new_tron_address') ->name('sApiPixget_tron_addresse');
 
 
 Route::post('v1/get_tron_balance','TronCtrl@get_tron_address_balance') ->name('sApiPixget_tron_addresse');
 
 
 Route::post('v1/all_address_balance','TronCtrl@all_address_balance') ;
 ...
 Route::post('v3/deposit','PixCtrlV3@getdeposit')  ;
 
 Route::any('v3/transaction','PixCtrlV3@gettransaction')  ;
 
 Route::any('v3/getMetaData/{transaction_id}','PixCtrlV3@getMetaData')  ;
 
 
  
 Route::any('v3/withdraw','PixCtrlV3@getWithdraw')  ;
  
 Route::any('v3/PayOut','PixCtrlV3@getWithdraw')  ;
 
  
 Route::any('v3/balance','PixCtrlV3@getBalance')  ;
 
  
 Route::any('v3/transactions','PixCtrlV3@getTransactions')  ;
 
  
 
  
 Route::any('v3/QRcode','PixCtrlV3@getQRcode')  ;
 ...
 Route::any('Test','PixCtrlV4@Test')  ;
 
 
 Route::any('Status','PixCtrlV4@getStatus')  ;
 
 Route::any('PayOut','PixCtrlV4@getWithdraw')  ;
 
 Route::any('Balance','PixCtrlV4@getBalance')  ;
 
 Route::any('Deposits','PixCtrlV4@Deposits')  ;
 
 Route::any('QRcode','PixCtrlV4@getQRcode')  ;
 
      
 Route::prefix('admin')->group( function() {
 
 
 Route::any('Deposits','AdminPixCtrlV4@getDeposits')  ;
...
Route::get('Wallet','BTVCv2Ctrl@Wallet')->name('BTVCv2Ctrl@Wallet')  ;
 ...
 Route::prefix('wallet')->group( function() {
     ...
     /* new calls */
       ...
       Route::get('send_fund_email_otp','SystemWithdrawCtrl@send_fund_email_otp')->name('SystemCtrl@send_fund_email_otp')  ;
     
// Route::get('/send_fund_email_otp', 'SystemWithdrawCtrl@send_fund_email_otp')->name('systemwithdraw.send_fund_email_otp') ;
...
Route::group([
    ...
    Route::post('login', 'Auth\AuthController@login')->name('login');
     ...
     Route::post('loginbygoogle', 'Auth\AuthController@loginbygoogle')->name('loginbygoogleloginbygoogle');
...
Route::post('postkycnew', 'Auth\AuthController@postkycnew')->name('auth.AuthControllerpostkycnew');
   ...
   Route::get('API_KEY', 'Auth\AuthController@updateAPI_KEY');
...
Route::prefix('refer')->group( function() {
        Route::get('referuser_list', 'ReferCtrl@referuser_list')->name('ReferCtrl@referuser_list') ; 
        
     Route::get('user_investment', 'ReferCtrl@user_investment')->name('ReferCtrl@user_investment') ; 
});

Route::prefix('systemwithdraw')->group( function() {
    
 Route::get('/send_fund_email_otp', 'SystemWithdrawCtrl@send_fund_email_otp')->name('systemwithdraw.send_fund_email_otp') ; 
        
 Route::get('/sendFund', 'SystemWithdrawCtrl@sendFund')->name('systemwithdraw.sendFund') ; 
...
Route::prefix('systemplan')->group( function() {
    ...
    Route::get('/getExchangeRate', 'SystemplanCtrl@getExchangeRate')->name('system.getExchangeRate') ; 
    
 Route::get('/investment/{i}', 'SystemplanCtrl@investment')->name('system.investment') ; 
 
  Route::get('/investmentbyuser/{i}', 'SystemplanCtrl@investmentbyuser')->name('system.investmentbyuser') ; 
  
    Route::get('investments_info/{i}','SystemplanCtrl@investments_info')->name('system.SystemplanCtrlinvestments_info_details')  ;
    Route::get('investments_details','SystemplanCtrl@investments_details')->name('system.SystemplanCtrlinvestments_details')  ;
    ...
    Route::get('robot_by_id/{robot_id}','SystemplanCtrl@robot_by_id')->name('system.Systrobot_by_idails')  ;
   ...
   Route::get('investplanfetch','SystemplanCtrl@investplanfetch')->name('system.SystemplanCtrlinvestplanfetch')  ;
     ...
     Route::get('allbalance','DashboardCtrl@topboxes')->name('sysdlallbalance')  ;
     
        Route::get('investmentsreport','SystemplanCtrl@investmentsreport')->name('system.SystemplanCtrlinvestmentsreport')  ;
     
      Route::post('pixdepositaddress','SystemCtrl@pixdepositaddress')->name('system.SystemplanCtrlpixdepositaddress')  ;
     
       Route::get('getdepositreport','SystemplanCtrl@getdepositreport')->name('system.SystemplanCtrlgetdepositreport')  ;
       
      Route::post('addinvestmentplan','SystemplanCtrl@addinvestmentplan')->name('system.SystemplanCtrladdinvestmentplan')  ;

Route::get('delete_plan','SystemplanCtrl@delete_plan')->name('system.SystemplanCtrldelete_plan')  ;

Route::get('edit_plan','SystemplanCtrl@edit_plan')->name('system.SystemplanCtrledit_plan')  ;

Route::post('updateinvestmentplan','SystemplanCtrl@updateinvestmentplan')->name('system.SystemplanCtrlupdateinvestmentplan')  ;
...
Route::prefix('system')->group( function() {
    Route::get('system_notification','SystemCtrl@system_notification') ->name('SystemCtrl@system_notification')  ;
         Route::post('USDTTron','TronCtrl@USDTTron1') ->name('TronCtrl@USDTTron')  ;
         
         
            Route::post('sendUSDT','TronCtrl@sendUSDT') ->name('TronCtrl@sendUSDT')  ;
            
            
            
          Route::post('dubaikoindepositaddress','SystemCtrl@dubaikoindepositaddress') ->name('SystemCtrl@dubaikoindepositaddress')  ;
         
         
         Route::post('currencyexchange','SystemCtrl@currencyexchange')->name('system.SystemCtrlcurrencyexchange')  ; 
         ; 
         
//   Route::get('loginRoute::post('currencyexchange','SystemCtrl@currencyexchange')->name('system.SystemCtrlcurrencyexchange')  ; _history1','SystemCtrl@login_history1') ->name('SystemCtrl@login_history')  ;
    ...
    Route::post('searchaddress','SystemCtrl@searchaddress')->name('SystemCtrlsearchaddress')  ;
     ...
     Route::post('/widthdraw_coin_process', 'SystemWithdrawCtrl@widthdraw_coin_process')->name('widthdraw_coin_process') ;
 
     Route::get('/widthdraw_coin_history', 'SystemWithdrawCtrl@widthdraw_coin_history')->name('widthdraw_coin_history') ;
 
    
      Route::get('getdepositreportbydate','SystemCtrl@getdepositreportbydate')->name('SystemCtrlgetdepositreportbydate')  ;
   ...
   Route::get('alldatetransaction','SystemCtrl@alldatetransaction')->name('SystemCtrlalldatetransaction')  ;
     ...
     Route::get('ticket_list','SystemCtrl@ticket_list') ->name('SystemCtrlticket_list')  ;
      ...
      Route::get('getticket_message/{id}','SystemCtrl@getticket_message')->name('SystemCtrlgetticket_message')  ;
       ...
       Route::post('pixdepositaddress1', 'SystemCtrl@pixdepositaddress')->name('SystemCtrl@pixdepositaddress') ; 
                  
    Route::get('getdepositreport', 'SystemCtrl@getdepositreport')->name('SystemCtrl@getdepositreport') ; 
                 
    Route::post('SearchAmountForm', 'SystemCtrl@SearchAmountForm')->name('SystemCtrl@SearchAmountForm') ; 
    
    Route::post('SearchTransactionForm', 'SystemCtrl@SearchTransactionForm')->name('SystemCtrl@SearchTransactionForm') ; 
...
Route::get('ExchangeOrders','SystemCtrl@ExchangeOrders')   ;
...
//Route::get('users','SystemCtrl@LedgetUsers')   ;
...
Route::any('rate/{c1}/{c2}', 'ExchangeCtrl@rates') ->name('exchange.ExchangeCtrltickers')  ;
 ...
 Route::middleware(['auth:api'])->group(function () {
   ...
   Route::post('setpassword','Admin2Ctrl@setpassword')->name('Sdtpassword')  ;
...
Route::get('/autologin/{id}', 'AdminController@autoLoginbyID')->name('AdminControllerautologin');
  ...
  Route::post('/updatewidthdraw/{id}', 'AdminController@updatewidthdraw'  )->name('AdminControllerallwidthdraw');
    ...
    Route::get('/LedgetTransactionsdepositsWithCoin', 'AdminController@LedgetTransactionsdepositsWithCoin')->name('LedgetTransactionsdepositsWithCoin');
